    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau', models.CharField(choices=[('BEPC', 'BEPC'), ('BAC', 'BAC'), ('LICENCE', 'LICENCE')], default='BAC', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(verbose_name=300)),
                ('is_true', models.BooleanField(default=False)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choix', to='quiz.questions')),
            ],
        ),
        migrations.CreateModel(
            name='Reponses',
            fields=[
                ...
                ('reponse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.choix')),
            ],
        ),
        migrations.CreateModel(
